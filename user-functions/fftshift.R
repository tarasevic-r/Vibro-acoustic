...
# Review: 2020-01-10T1344 AU

fftshift <-
  function(input_matrix, dim = -1) {
    ...
    swap_up_down <- function(input_matrix) {
      ...
      return(
        rbind(
          input_matrix[((rows_half+1):rows), (1:cols)]
          , input_matrix[(1:rows_half), (1:cols)])
      )
    }
    ...
    swap_left_right <- function(input_matrix) {
      ...
      return(
        cbind(
          input_matrix[1:rows, ((cols_half+1):cols)]
          , input_matrix[1:rows, 1:cols_half])
      )
    }
...
ifftshift <- function(input_matrix, dim = -1) {
  ...
  swap_up_down <- function(input_matrix) {
    ...
    return(
      rbind(input_matrix[((rows_half+1):rows), (1:cols)]
            , input_matrix[(1:rows_half), (1:cols)])
    )
  }
  ...
  swap_left_right <- function(input_matrix) {
    ...
    return(
      cbind(input_matrix[1:rows, ((cols_half+1):cols)]
            , input_matrix[1:rows, 1:cols_half])
    )
  }
